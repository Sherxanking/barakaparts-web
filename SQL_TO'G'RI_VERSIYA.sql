...
-- ============================================
-- To'g'ri versiya - Test user qismi olib tashlangan
-- ============================================
...
-- TUGADI!
-- ============================================
-- ⚠️ MUHIM: Test user yaratish uchun quyidagi qadamlarni bajaring:
-- 1. Supabase Dashboard → Authentication → Users → Add user
-- 2. Email va Password kiriting
-- 3. User ID ni ko'chirib oling
-- 4. Quyidagi SQL ni bajarish (USER_ID ni o'zgartiring):
-- 
-- INSERT INTO users (id, name, email, role) VALUES
--   ('USER_ID_BU_YERGA', 'User Name', 'user@example.com', 'boss')
