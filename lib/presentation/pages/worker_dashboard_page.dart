...
/// 
/// Bu sahifa faqat workerlar uchun. Ular olib ketayotgan orderlarni
/// belgilash va ularni completed qilish imkonini beradi.
...
class _WorkerDashboardPageState extends State<WorkerDashboardPage> {
  ...
  Future<void> _loadAssignedOrders() async {
    ...
    try {
      // Worker sifatida tayinlangan orderlarni olish
  ...
  Future<void> _completeSelectedOrders() async {
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        // OrderService orqali complete qilish - ID orqali
        for (final orderId in _selectedOrderIds) {
          // Order modelini olish
  ...
  Widget build(BuildContext context) {
    ...
    // Faqat workerlar uchun
    if (currentUser == null || (!currentUser.isWorker && !currentUser.isManager)) {
      return Scaffold(
