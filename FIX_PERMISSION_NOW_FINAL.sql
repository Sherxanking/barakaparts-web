-- ============================================
-- FIX PERMISSION NOW - FINAL YECHIM
-- ============================================
-- 
...
-- ============================================
-- STEP 1: VAQTINCHA RLS'NI O'CHIRISH
-- (User'ni qo'shish uchun)
-- ============================================
ALTER TABLE public.users DISABLE ROW LEVEL SECURITY;

-- ============================================
-- STEP 2: SECURITY DEFINER FUNKSIYASI YARATISH
-- ============================================
...
-- ============================================
-- STEP 3: USER'NI QO'SHISH (RLS o'chirilgan holda)
-- ============================================
...
-- ============================================
-- STEP 4: BARCHA ESKI POLICIES'NI O'CHIRISH
-- ============================================
DO $$
DECLARE
  r RECORD;
...
-- ============================================
-- STEP 6: YANGI RLS POLICIES YARATISH
-- ============================================
