...
**Qadamlari:**
1. Manager yoki Boss bilan login qiling
2. Parts page'ga o'ting
3. "+" tugmasini bosing
4. Part name: "Test Part"
5. Quantity: 10
6. Min Quantity: 3
7. "Add" tugmasini bosing
...
**Qadamlari:**
1. Har qanday user bilan login qiling
2. Parts page'ga o'ting

**Kutilgan natija:**
- ✅ Barcha parts ko'rinadi
...
**Qadamlari:**
1. Manager yoki Boss bilan login qiling
2. Parts page'da part'ni tanlang
3. "Edit" tugmasini bosing
4. Quantity'ni o'zgartiring
5. "Update" tugmasini bosing

**Kutilgan natija:**
- ✅ Part muvaffaqiyatli yangilanadi
- ✅ "Part updated successfully" xabari
...
**Qadamlari:**
1. Boss bilan login qiling
2. Parts page'da part'ni tanlang
3. "Delete" tugmasini bosing
4. Tasdiqlash

**Kutilgan natija:**
- ✅ Part muvaffaqiyatli o'chiriladi
- ✅ "Part deleted successfully" xabari
